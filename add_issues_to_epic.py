import json
import requests
from my_secrets import DEVTOPIA_TOKEN, ZENTOPIA_API_URL, ZENTOPIA_REPO_ID
import get_stuff
...
def add_issues_to_epic_from_issue_body(issue_number, epic_issue_number):
    ...
    json_data = {
        "add_issues": [{"repo_id": ZENTOPIA_REPO_ID, "issue_number": issue_number} for issue_number in issue_numbers],
        "remove_issues": []
    }
